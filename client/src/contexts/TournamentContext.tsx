...
interface TournamentContextType {
  ...
  createTournament: (data: { name: string; description: string; type: string; teamCategory?: 'club' | 'national'; teamCount: number; groupSize?: number; teamCountries?: string[]; startTime?: string; selectedTeams?: TeamCandidate[] }) => Promise<void>;
...
export const TournamentProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const createTournament = async (data: { name: string; description: string; type: string; teamCategory?: 'club' | 'national'; teamCount: number; groupSize?: number; teamCountries?: string[]; startTime?: string; selectedTeams?: TeamCandidate[] }) => {
    try {
